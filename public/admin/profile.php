                ...
                <div class="col-md-8">
                        ...
                        <form method="POST" action="../update_profile.php" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" id="email" name="email"
                                    value="admin@livraison-express.ma" required>
                            </div>

                            <div class="mb-3">
                                <label for="phone" class="form-label">Téléphone</label>
                                <input type="tel" class="form-control" id="phone" name="phone" value="+212 5XX XXX XXX"
                                    required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="address" name="address"
                                    rows="2">Siège social, Casablanca</textarea>
                            </div>
                    ...
                    <div class="content-card mt-4">
                        ...
                        <form method="POST" action="../change_password.php">
                            ...
                            <div class="mb-3">
                                <label for="confirm_new_password" class="form-label">Confirmer le nouveau mot de
                                    passe</label>
                ...
                <div class="col-md-4">
                    ...
                    <div class="content-card">
                        ...
                        <div class="mb-3">
                            ...
                            <p class="text-muted">15 Jan 2024 à 09:30</p>
                        </div>
                    </div>
