        ...
        <div class="dashboard-container">
            ...
            <main class="main-content">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="content-card">
                            <h4 class="mb-3"><i class="bi bi-info-circle text-primary"></i> Informations de la commande
                            </h4>
                    ...
                    <div class="col-md-6">
                        <div class="content-card">
                            ...
                            <div class="mb-3">
                                ...
                                <p class="mb-0">123 Boulevard Mohammed V<br>Casablanca 20000<br>Tél: +212 6XX XXX XXX
                                </p>
                            </div>
                            <hr>
                            <div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-3">
                                        ...
                                        <div>
                                            ...
                                            <small class="text-muted"><i class="bi bi-star-fill text-warning"></i>
                                                4.8/5</small>
                                        </div>
                                    </div>
                                    <div class="mb-2">
                                    ...
                                    <p class="mb-3"><i class="bi bi-check-circle text-success"></i> Express disponible
                                    </p>
