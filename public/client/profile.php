                        ...
                        <form method="POST" action="../update_profile.php" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="first_name" name="first_name" value="Ahmed" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="last_name" class="form-label">Nom</label>
                                    <input type="text" class="form-control" id="last_name" name="last_name" value="Mansouri" required>
                                </div>
                            </div>

                            <div class="mb-3">
                                <label for="email" class="form-label">Adresse email</label>
                                <input type="email" class="form-control" id="email" name="email" value="ahmed.mansouri@example.com" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="address" name="address" rows="2">123 Boulevard Mohammed V, Casablanca</textarea>
                            </div>

                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="city" class="form-label">Ville</label>
                                    <input type="text" class="form-control" id="city" name="city" value="Casablanca">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="postal_code" class="form-label">Code postal</label>
                                    <input type="text" class="form-control" id="postal_code" name="postal_code" value="20000">
                                </div>
                            </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="content-card">
                        ...
                        <div class="mb-3">
                            ...
                            <p class="text-muted">Janvier 2023</p>
                        </div>
                        <div class="mb-3">
                            <strong>Commandes totales</strong>
                            <p class="text-muted">18 commandes</p>
                        </div>
                        <div class="mb-3">
                            <strong>Commandes terminées</strong>
                            <p class="text-muted">15 commandes</p>
                        </div>
                        <div class="mb-3">
